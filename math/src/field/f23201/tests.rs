...
fn sextic_mul() {
    ...
    // a * b = (2586336*v^2 + 1083175*v + 6492423)*z + 4983310*v^2 + 4866964*v + 6625095
    let expected = <SexticExtension<BaseElement>>::new(
        CubeExtension::new(
            BaseElement::new(6625095),
            BaseElement::new(4866964),
            BaseElement::new(4983310),
        ),
        CubeExtension::new(
...
fn sextic_frobenius() {
    ...
    // a.frobenius() = a^p = (3486585*v^2 + 255876*v + 632993)*z + 4801732*v^2 + 3629074*v + 6291822
    let expected = <SexticExtension<BaseElement>>::new(
        CubeExtension::new(
        ...
        CubeExtension::new(
            BaseElement::new(632993),
            BaseElement::new(255876),
            BaseElement::new(3486585),
        ),
    );
